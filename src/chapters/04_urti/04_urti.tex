...
\begin{align*}
    ...
    \end{cases}
\end{align*}
Nella realtà comunemente osservabile, urti elasti avvengono in genere tra
oggetti che rimbalzano tra loro dopo un urto, anche se in realtà l'energia
cinetica viene dissipata in altre forme (suono e calore), rendendo l'urto stesso non del tutto
elastico. Sono idealmente elastici urti tra particelle.
