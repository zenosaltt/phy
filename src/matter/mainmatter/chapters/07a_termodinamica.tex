...
\begin{marginfigure}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw[<->] (\Depth + 0.2,\Width,0) -- (\Depth + 0.2,0,0);
            \draw (2.2,1) node[right]{$L$};

            \draw[black,fill=red!60] (O) -- (C) -- (G) -- (D) -- cycle;% Bottom Face
            ...
            \draw[->] (0.5,0.5) -- (0,-0.2);
            \draw[->] (0,-0.2) -- (-0.2,0.3);
            \shade[ball color = black!80, opacity = 1] (0.5,0.5) circle (3pt);
            ...
            \end{tikzpicture}
    \end{center}
    \caption{La teoria cinetica dei gas è spesso mostrata considerando
    il semplice caso di un cubo contenente particelle di gas ideale.
    Ne isoliamo una sola per praticità.}
    \label{chine_theory}
\end{marginfigure}
...
\begin{marginfigure}
    \begin{center}
        \begin{tikzpicture}
            ...
            \shade[ball color = black!80, opacity = 1] (0,0) circle (2.3pt) node[below right]{$m$};
            \shade[ball color = black!80, opacity = 1] (1.95,2) circle (2.3pt) node[below right]{};
            \shade[ball color = black!80, opacity = 1] (0,4) circle (2.3pt) node[below right]{};
