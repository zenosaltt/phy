...
\begin{marginfigure}
    ...
    $AB$ descrive un segmento verticale che ``non ha larghezza''.}
\end{marginfigure}
...
\begin{marginfigure}
    \begin{center}
        \begin{tikzpicture}
            ...
            % POINTS
            \fill[mydarkblue] (A) circle(0.05) node[right = 2, above = 2] {$A$};
            \fill[mydarkblue] (B) circle(0.05) node[right = 2, above = 2] {$B$};
    ...
    dalla curva tratteggiata. Più $\gamma$ cresce ($\gamma > 0$
    per la relazione di Mayer), più la pendenza dell'adiabatica si
    fa forte.}
\end{marginfigure}
