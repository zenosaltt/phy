...
forza elastica e così via. Ma tutte queste forze, per quanto ci è noto da
osservazioni del microcosmo,
sono riconducibili a quattro interazioni fondamentali che si
manifestano nella materia. Dalla più forte alla più debole, esse
sono:
\begin{itemize}
    \item \textit{Interazione forte}: Tiene insieme i nuclei
    degli atomi.

    \item \textit{Interazione elettromagnetica}: accoppia le cariche elettriche e
    le correnti. Strano ma vero, molte forze quotidiane e studiate nel capitolo di
    dinamica (attrito, forza elastica) sono in realtà spiegabili come interazioni
    elettromagnetiche che avvengono su scala microscopica.
...
La prima ad esser stata studiata è la forza più debole tra tutte.
